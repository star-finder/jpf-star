...
public class LXOR extends gov.nasa.jpf.jvm.bytecode.LXOR {
	...
	public Instruction execute(ThreadInfo ti) {
		...
		if (sym_v1 == null && sym_v2 == null)
			...
			if (sym_v1 != null) {
				if (sym_v2 != null) {
					result = new BinaryExpression(Operator.XOR, sym_v1, sym_v2);
				} else {
					result = new BinaryExpression(Operator.XOR, sym_v1, new LiteralExpression(v2));
				}
			} else {
				result = new BinaryExpression(Operator.XOR, new LiteralExpression(v1), sym_v2);
			}
