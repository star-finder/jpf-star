...
public class LOR extends gov.nasa.jpf.jvm.bytecode.LOR {
	...
	public Instruction execute(ThreadInfo ti) {
		...
		if (sym_v1 == null && sym_v2 == null)
			...
			if (sym_v1 != null) {
				if (sym_v2 != null) {
					result = new IntegerBinaryExpression(Operator.OR, sym_v1, sym_v2);
				} else {
					result = new IntegerBinaryExpression(Operator.OR, sym_v1, new IntegerLiteral(v2));
				}
			} else {
				result = new IntegerBinaryExpression(Operator.OR, new IntegerLiteral(v1), sym_v2);
			}
