				...
				if (conditionValue == -1) {
					if (sym_v1 != null) {
						if (sym_v2 != null) {
							...
							pc.addComparisonTerm(Comparator.LT, sym_v1, new LiteralExpression(v2));
						}
					} else {
						pc.addComparisonTerm(Comparator.LT, new LiteralExpression(v1), sym_v2);
					}
					...
					if (sym_v1 != null) {
						if (sym_v2 != null) {
							...
							pc.addComparisonTerm(Comparator.EQ, sym_v1, new LiteralExpression(v2));
						}
					} else {
						pc.addComparisonTerm(Comparator.EQ, new LiteralExpression(v1), sym_v2);
					}
					...
					if (sym_v1 != null) {
						if (sym_v2 != null) {
							...
							pc.addComparisonTerm(Comparator.GT, sym_v1, new LiteralExpression(v2));
						}
					} else {
						pc.addComparisonTerm(Comparator.GT, new LiteralExpression(v1), sym_v2);
					}
