...
public class IADD extends gov.nasa.jpf.jvm.bytecode.IADD {
	...
	public Instruction execute(ThreadInfo ti) {
		...
		if(sym_v1 == null && sym_v2 == null) {
			...
			if(sym_v1 != null) {
				if (sym_v2 != null) {
					result = new IntegerBinaryExpression(Operator.PLUS, sym_v1, sym_v2);
				} else {
					result = new IntegerBinaryExpression(Operator.PLUS, sym_v1, new IntegerLiteral(v2));
				}
			} else {
				result = new IntegerBinaryExpression(Operator.PLUS, new IntegerLiteral(v1), sym_v2);
			}
