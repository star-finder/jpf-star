...
public class RedBlackTree_containsValueTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre containsValue == rbt(this_root,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=star.examples.rbt.TreeMap.containsValue(sym)",
