...
public class BinarySearchTree_insertTest extends TestJPF {
...
//		String pre = "pre insert == bst(this_root,this_min,this_max)";
		String pre = "pre insert == bst(this_root)";
...
//				"+star.min_int=-100",
//				"+star.max_int=100",
				"+star.test_path=build/tmp/gov/nasa/jpf/star/examples/bst",
				"+star.test_package=gov.nasa.jpf.star.examples.bst",
				"+star.test_imports=gov.nasa.jpf.star.examples.Utilities",
				"+classpath=build/examples", 
				"+sourcepath=src/examples",
				"+symbolic.method=gov.nasa.jpf.star.examples.bst.BinarySearchTree.insert(sym)",
