...
public class BinarySearchTree_findMinTest extends TestJPF {
...
//		String pre = "pre findMin == bst(this_root,this_min,this_max)";
		String pre = "pre findMin == bst(this_root)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.bst.BinarySearchTree.findMin()",
