...
public class DoubleLinkedList_addLastTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre addLast == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=star.examples.doublelinkedlist.DoubleLinkedList.addLast(sym)",
