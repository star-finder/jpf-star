...
public class RedBlackTree_getTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre get == rbt(this_root,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.rbt.TreeMap.get(sym)",
