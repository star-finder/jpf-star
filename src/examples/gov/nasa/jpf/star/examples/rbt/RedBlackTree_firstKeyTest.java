...
public class RedBlackTree_firstKeyTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre firstKey == rbt(this_root,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.rbt.TreeMap.firstKey()",
