...
public class MyStack_makeEmptyTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre makeEmpty == stack(this_topOfStack)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.stack.StackLi.makeEmpty()",
