...
public class MyStack_isFullTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre isFull == stack(this_topOfStack)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.stack.StackLi.isFull()",
