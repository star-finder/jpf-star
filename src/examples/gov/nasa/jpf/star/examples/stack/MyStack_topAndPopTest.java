...
public class MyStack_topAndPopTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre topAndPop == stack(this_topOfStack)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.stack.StackLi.topAndPop()",
