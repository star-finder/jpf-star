...
public class MyStack_pushTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre push == stack(this_topOfStack)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.stack.StackLi.push(sym)",
