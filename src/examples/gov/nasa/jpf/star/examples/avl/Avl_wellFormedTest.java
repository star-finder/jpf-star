...
public class Avl_wellFormedTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre wellFormed == avl(this_root)";
...
//				"+star.test_imports=",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.avl.AvlTree.wellFormed()",
