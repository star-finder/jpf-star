...
public class MyLinkedList_reverseTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre reverse == this__header::MyListNode<element,next> * sll(next)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.linkedlist.MyLinkedList.reverse()",
