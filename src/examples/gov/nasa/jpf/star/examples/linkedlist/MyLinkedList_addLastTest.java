...
public class MyLinkedList_addLastTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre addLast == this__header::MyListNode<element,next> * sll(next)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.linkedlist.MyLinkedList.addLast(sym)",
