...
public class MyLinkedList_firstTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre first == this__header::MyListNode<element,next> * sll(next)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.linkedlist.MyLinkedList.first()",
