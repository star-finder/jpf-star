...
public class DoubleLinkedList_getTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre get == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.get(sym)",
