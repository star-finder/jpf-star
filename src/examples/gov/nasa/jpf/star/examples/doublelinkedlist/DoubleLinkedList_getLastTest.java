...
public class DoubleLinkedList_getLastTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre getLast == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.getLast()",
