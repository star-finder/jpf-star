...
public class DoubleLinkedList_addTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre add == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.add(sym)",
