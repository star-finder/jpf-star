...
public class DoubleLinkedList_addFirstTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre addFirst == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.addFirst(sym)",
