...
public class DoubleLinkedList_setTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre set == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.set(sym#sym)",
