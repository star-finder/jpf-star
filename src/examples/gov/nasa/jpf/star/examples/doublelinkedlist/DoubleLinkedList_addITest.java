...
public class DoubleLinkedList_addITest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre addI == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.addI(sym#sym)",
