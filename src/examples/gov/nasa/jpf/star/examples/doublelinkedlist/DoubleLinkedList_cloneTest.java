...
public class DoubleLinkedList_cloneTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre clone == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.clone()",
