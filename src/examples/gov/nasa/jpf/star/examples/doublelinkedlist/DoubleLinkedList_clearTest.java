...
public class DoubleLinkedList_clearTest extends TestJPF {
	...
	private void initPrecondition() {
		String pre = "pre clear == dll(this_header,this_size)";
...
//				"+star.max_int=100",
				...
				"+symbolic.method=gov.nasa.jpf.star.examples.doublelinkedlist.DoubleLinkedList.clear()",
