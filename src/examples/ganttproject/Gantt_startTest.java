...
public class Gantt_startTest extends TestJPF {
	...
	private void initDataNode() {
		...
		String data2 = "data GraphData {void myLayers; void myBackup; Transaction myTxn}";
	...
	private void initPredicate() {
		String pred = "pred cond(trans,myData) == trans::Transaction<isRunning,_> * myData::GraphData<_,_,trans1> & trans1=trans";
